...
${tw`focus:(outline-none ring-1 ring-yellow-300 ring-offset-2 ring-offset-neutral-500)`}
...
&:after {
  ...
  ${tw`w-5 h-5 absolute rounded-full transform transition-transform flex justify-center items-center bg-yellow-300 shadow-bar`}
}

&:focus {
  &:after {
    ${tw`outline-none ring-1 ring-blue-500 ring-offset-2 ring-offset-neutral-500`}
  }
}

&:checked {
  ${tw`focus:(outline-none ring-1 ring-blue-500 ring-offset-2 ring-offset-neutral-500)`}
  &:focus {
    &:after {
      ${tw`outline-none ring-1 ring-yellow-300 ring-offset-2 ring-offset-neutral-500`}
    }
  }
  &:after {
